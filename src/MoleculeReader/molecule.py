...
import random
from pathlib import Path
_basedir = Path.cwd().parent
if str(_basedir) not in sys.path:
    sys.path.append(str(_basedir))
...
class Molecule(object):
    ...
    _colour_frame = pd.read_csv(Path(__file__).resolve().parent / "jmolcolors.csv")
    _colour_list = {}
