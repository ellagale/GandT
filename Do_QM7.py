...
num_of_molecules = len(train_dataset) + len(valid_dataset) + len(test_dataset)
...
qm7_df=pd.read_csv(os.path.join(save_dir,'qm7.csv')) # has smiles strings
...
mol_idx = 0
make_hdf5_dataset=make_dataset
