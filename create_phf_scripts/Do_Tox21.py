...
######################################################################################################################
##########################   Tox21  Tox21   Tox21   Tox21   Tox21   Tox21   Tox21    #################################
######################################################################################################################
...
if make_hdf5:
    ...
    if True:
        ...
        molID_ds = h.create_or_recreate_dataset(outfile, "molID", (num_of_molecules_to_do), dtype=np.string_type)
        ...
        PCA_18_ds = h.create_or_recreate_dataset(outfile, "PCA_18", (num_of_molecules_to_do), dtype=np.float32)
            # # #                           targets                                         # # #
        target_NR_AR_ds = h.create_or_recreate_dataset(outfile, "NR_AR", (num_of_molecules_to_do), dtype=np.int8)
        target_NR_AR_LBD_ds = h.create_or_recreate_dataset(outfile, "NR_AR_LBD", (num_of_molecules_to_do), dtype=np.int8)
        target_NR_AhR_ds = h.create_or_recreate_dataset(outfile, "NR_AhR", (num_of_molecules_to_do), dtype=np.int8)
        target_NR_Aromatase_ds = h.create_or_recreate_dataset(outfile, "NR_Aromatase", (num_of_molecules_to_do), dtype=np.int8)
        target_NR_ER_ds = h.create_or_recreate_dataset(outfile, "NR_ER", (num_of_molecules_to_do), dtype=np.int8)
        target_NR_ER_LBD_ds = h.create_or_recreate_dataset(outfile, "NR_ER_LBD", (num_of_molecules_to_do), dtype=np.int8)
        target_NR_PPAR_gamma_ds = h.create_or_recreate_dataset(outfile, "NR_PPAR_gamma", (num_of_molecules_to_do), dtype=np.int8)
        target_SR_ARE_ds = h.create_or_recreate_dataset(outfile, "SR_ARE", (num_of_molecules_to_do), dtype=np.int8)
        target_SR_ATAD5_ds = h.create_or_recreate_dataset(outfile, "SR_ATAD5", (num_of_molecules_to_do), dtype=np.int8)
        target_SR_HSE_ds = h.create_or_recreate_dataset(outfile, "SR_HSE", (num_of_molecules_to_do), dtype=np.int8)
        target_SR_MMP_ds = h.create_or_recreate_dataset(outfile, "SR_MMP", (num_of_molecules_to_do), dtype=np.int8)
        target_SR_p53_ds = h.create_or_recreate_dataset(outfile, "SR_p53", (num_of_molecules_to_do), dtype=np.int8)


        #['NR_AR', 'NR_AR-LBD', 'NR_AhR', 'NR_Aromatase',
        # 'NR_ER','NR_ER_LBD', 'NR_PPAR_gamma', 'SR_ARE',
        # 'SR_ATAD5', 'SR_HSE','SR_MMP', 'SR_p53']
