...
#make_dataset = False
if make_dataset:
    with open(os.path.join(save_dir,'x_data_qm9.csv'), 'w') as f:
        with open(os.path.join(save_dir, 'y_data_qm9.csv'), 'w') as y_fh:
            # train
...
#                               load data                                                                        #
##################################################################################################################
topl_features_df = pd.read_csv(os.path.join(save_dir,'x_data_qm9.csv'))
topl_targets_df = pd.read_csv(os.path.join(save_dir,'y_data_qm9.csv'))

topl_qm9_all_mat=topl_features_df

qm9_df=pd.read_csv(os.path.join(save_dir,'qm9_SMILES.csv')) # has smiles strings

with open(os.path.join(save_dir,'x_data_qm9.csv'), 'r') as read_obj:
    # pass the file object to reader() to get the reader object
    csv_reader = reader(read_obj)
    # Pass reader object to list() to get a list of lists
    topl_QM9_all_list = list(csv_reader)
    print(topl_QM9_all_list)

topl_QM9_all_list = np.array(topl_QM9_all_list)

with open(os.path.join(save_dir,'y_data_QM9.csv'), 'r') as read_obj:
    # pass the file object to reader() to get the reader object
    csv_reader = reader(read_obj)
    # Pass reader object to list() to get a list of lists
    targets_topl_QM9_all_list = list(csv_reader)
    print('Example y data')
    print(targets_topl_QM9_all_list[0])
...
pca = PCA(n_components=num_of_topol_features)
principalComponents_large = pca.fit_transform(topl_QM9_all_list)
####################################################################################################################
    ...
    if True:
        ...
        for mol_idx in range(num_of_molecules_to_do):
            ...
            P_pers_img_1_ds[mol_idx],P_pers_img_2_ds[mol_idx],P_pers_img_3_ds[mol_idx]
             ) = np.array(topl_QM9_all_list[mol_idx], dtype='f8')
                #                           PCs                         #
            ...
            # targets
            # # #                           targets                                         # # #
            target_E1_CC2_ds[mol_idx] = np.array(targets_topl_QM9_all_list[mol_idx][0], dtype='f8')
            target_E2_CC2_ds[mol_idx] = np.array(targets_topl_QM9_all_list[mol_idx][1], dtype='f8')
            target_f1_CC2_ds[mol_idx] = np.array(targets_topl_QM9_all_list[mol_idx][2], dtype='f8')
            target_f2_CC2_ds[mol_idx] = np.array(targets_topl_QM9_all_list[mol_idx][3], dtype='f8')
            target_E1_PBE0_ds[mol_idx] = np.array(targets_topl_QM9_all_list[mol_idx][4], dtype='f8')
            target_E2_PBE0_ds[mol_idx] = np.array(targets_topl_QM9_all_list[mol_idx][5], dtype='f8')
            target_f1_PBE0_ds[mol_idx] = np.array(targets_topl_QM9_all_list[mol_idx][6], dtype='f8')
            target_f2_PBE0_ds[mol_idx] = np.array(targets_topl_QM9_all_list[mol_idx][7], dtype='f8')
            target_E1_PBE0_2_ds[mol_idx] = np.array(targets_topl_QM9_all_list[mol_idx][8], dtype='f8')
            target_E2_PBE0_2_ds[mol_idx] = np.array(targets_topl_QM9_all_list[mol_idx][9], dtype='f8')
            target_f1_PBE0_2_ds[mol_idx] = np.array(targets_topl_QM9_all_list[mol_idx][10], dtype='f8')
            target_f2_PBE0_2_ds[mol_idx] = np.array(targets_topl_QM9_all_list[mol_idx][11], dtype='f8')
            target_E1_CAM_ds[mol_idx] = np.array(targets_topl_QM9_all_list[mol_idx][12], dtype='f8')
            target_E2_CAM_ds[mol_idx] = np.array(targets_topl_QM9_all_list[mol_idx][13], dtype='f8')
            target_f1_CAM_ds[mol_idx] = np.array(targets_topl_QM9_all_list[mol_idx][14], dtype='f8')
            target_f2_CAM_ds[mol_idx] = np.array(targets_topl_QM9_all_list[mol_idx][15], dtype='f8')
